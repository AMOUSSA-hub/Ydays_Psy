          ...
          <View style={{ borderRadius: 32, backgroundColor: '#000', padding: 24, marginBottom: 28, alignItems: 'center' }}>
            ...
            {loading ? (
              ...
              <>
                ...
                {inviteCode && (
                  <View style={{ marginTop: 20, backgroundColor: '#fff', padding: 16, borderRadius: 24, alignItems: 'center' }}>
                    <Image
                      source={{ uri: `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${inviteCode}` }}
                      style={{ width: 150, height: 150 }}
                      contentFit="contain"
                    />
                    <Text style={{ fontSize: 10, fontWeight: '700', color: '#888', marginTop: 8, textTransform: 'uppercase', letterSpacing: 1 }}>
                      Scannez pour lier
                    </Text>
                  </View>
                )}
